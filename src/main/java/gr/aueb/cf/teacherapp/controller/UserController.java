...
public class UserController {
    ...
    public String insertUser(@Valid @ModelAttribute("userInsertDTO") UserInsertDTO userInsertDTO, BindingResult bindingResult, Model model, RedirectAttributes attrs) {
